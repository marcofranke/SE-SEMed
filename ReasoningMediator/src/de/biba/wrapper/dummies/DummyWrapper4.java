...
public class DummyWrapper4 extends DataSource{
	...
	public OntModel queryData(DataSourceQuery pDsc) {
		...
		String fdIds[] = {"RMC","GGA","GGA","RMC","GGA","RMC","GGA","RMC"};
		for(int i=0; i<8;i++){
			...
			baseModel.addProperty(i3, fd_id, new StringDatatype(fdIds[i]));
