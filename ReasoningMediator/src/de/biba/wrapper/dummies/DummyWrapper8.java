...
**/
	...
	public class DummyWrapper8 extends DataSource {
		...
		//ComplexOntClass benannter;
		 ...
		 DatatypeProperty name;
		 DatatypeProperty name_a;
		 
		 
		 
		 
		 
		 public DummyWrapper8() {
				super();
				...
				name_a = baseModel.createDatatypeProperty(namespace, "name_a");
				name_a.getDomain().add(namespace + "#Auto");
				name_a.setInverseFunctional(true);
				
				
				//ObjectPropery 
				
				hatX = baseModel.createObjectProperty(namespace, "hatX");
				hatX.getDomain().add(namespace+"#Person");
				hatX.getRange().add(namespace+"#Auto");
				
				hatX = baseModel.createObjectProperty(namespace, "hatX");
				hatX.getDomain().add(namespace+"#Lehrer");
				hatX.getRange().add(namespace+"#Student");
			...
			public OntModel queryData(DataSourceQuery pDsc) {
				...
				baseModel.addProperty (auto1, name_a, new StringDatatype("A1"));
				baseModel.addProperty (auto2, name_a, new StringDatatype("A2"));
				
				
				
				baseModel.addProperty (lehrer1, hatX, student1);
				baseModel.addProperty (lehrer2, hatX, student2);
				baseModel.addProperty (person1, hatX, auto1);
				baseModel.addProperty (person2,hatX, auto2);
